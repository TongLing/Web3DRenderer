...
OpenJsCad.Viewer = function(containerelement, initialdepth) {
  ...
  this.gl.onmousewheel = function(e) {
    ...
    if(wheelDelta) {
      var factor = Math.pow(1.001, -wheelDelta);
...
OpenJsCad.Processor.prototype = {
  ...
  updateDownloadLink: function() {
    ...
    this.generateOutputFileButton.innerHTML = "生成 "+ext.toUpperCase()+" 文件";
  },
  ...
  convertToBlob: function(object,format) {
    ...
    switch(format) {
      ...
      case 'dxf':
        ...
        break;
      case 'vrl':
        blob = object.fixTJunctions().tovrl();
        break;
      case 'stp':
        blob = object.fixTJunctions().tostp();
        break;
      default:
  ...
  supportedFormatsForCurrentObject: function() {
    if (this.currentObject instanceof CSG) {
      return ["vrl","stp","stlb", "stla", "amf", "x3d"];
